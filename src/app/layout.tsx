...
export const metadata: Metadata = {
  title: "Cinuse - Expert Engineering Solutions | Solar Design, Telecom & Data Centers",
  description: "Your one-stop shop for expert solar consulting, permit design, CAD/BIM drafting, telecom engineering, and data center solutions. Advanced design solutions built on precision, powered by innovation.",
};
